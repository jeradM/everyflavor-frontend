<template>
  <div class="flex flex-col">
    ...
    >
      <span
        class="md:w-1/2 w-1/3 cursor-pointer text-left flex items-center"
        @click="onSort('title')"
      >
        Title
      ...
      <span
        class="md:w-3/12 w-3/12 cursor-pointer flex items-center"
        @click="onSort('owner')"
      >
        Mixer
      ...
      <span
        class="md:w-1/6 w-3/12 cursor-pointer flex items-center"
      ...
      <span
        class="md:w-1/12 w-1/6 cursor-pointer flex items-center"
        @click="onSort('rating')"
      >
        Rating
